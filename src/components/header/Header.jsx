...
const Header = () => {
    ...
    return (
        <div className="w-11/12 md:w-10/12 mx-auto">
            ...
            {/* Cart Sidebar */}
            <div
                className={`fixed top-0 right-0 h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${cartOpen ? "translate-x-0" : "translate-x-full"
            ...
            {/* Mobile Menu Drawer */}
            <div
                className={`fixed top-0 left-0 h-full bg-[#f6f6f6] shadow-lg transform transition-transform duration-300 z-50 ${mobileMenuOpen ? "translate-x-0" : "-translate-x-full"
                    ...
                    <div className="bg-white rounded-xl flex flex-col text-sm text-gray-700 shadow-sm">
                        {categories.map((category, index) => (
                            <a
                                ...
                                className={`flex justify-between items-center py-3 px-4 ${index !== categories.length - 1
