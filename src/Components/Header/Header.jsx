  ...
  return (
    <div className="w-11/12 md:w-10/12 mx-auto">
      ...
      <div className="hidden md:flex items-center justify-between mt-6 md:mt-8 gap-4">
        <div>
          <a href="#">
            <img className="w-20 md:w-28 lg:w-31" src="/public/Img/logo.png" alt="logo" />
          </a>
        </div>
        <div className="flex-1">
          <input
            className="w-full h-11 md:h-12 bg-gray-200 text-black px-3 font-bold rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-400"
            type="search"
            placeholder="Search in..."
          />
        </div>
        <div className="flex items-center text-black gap-4 lg:gap-9 cursor-pointer flex-wrap justify-end">
          <div className="flex flex-col items-center text-xs lg:text-sm hover:text-orange-400 transition">
            <MapPinned size={20} />
          ...
          <div className="flex flex-col items-center text-xs lg:text-sm hover:text-orange-400 transition">
            ...
            >
              <div className="flex items-center relative">
                ...
                <p className="text-white absolute left-3 bottom-0 bg-orange-400 rounded-full min-w-5 h-5 flex items-center justify-center text-xs font-bold">
                  {cartItems.length}
                </p>
              </div>
          ...
          <div className="relative group flex flex-col items-center text-xs lg:text-sm hover:text-orange-400 transition">
            <List size={20} />
      ...
      <div className="md:hidden flex items-center justify-between mt-3 gap-2">
        ...
        <div className="flex-1">
          <input
            className="w-full h-10 bg-gray-200 text-black px-2 text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400"
            type="search"
            placeholder="Search..."
          />
        </div>
        <button
          onClick={() => setCartOpen(true)}
          className="cursor-pointer flex flex-col items-center text-black p-2 hover:text-orange-400 transition relative"
          aria-label="Open cart"
        >
          <div className="flex items-center relative">
            <ShoppingCart size={20} />
            <p className="text-white absolute left-2 -top-1 bg-orange-400 rounded-full min-w-4 h-4 flex items-center justify-center text-xs font-bold">
              {cartItems.length}
            </p>
          </div>
        </button>
      ...
      >
        <div className="p-4 md:p-5 flex justify-between items-center border-b">
          ...
          <button
            ...
            className="text-orange-400 font-bold hover:text-orange-600 transition"
              ...
              >
                ...
                <div className="flex flex-col gap-2 items-center">
                  <button
                    ...
                    className="font-bold cursor-pointer text-orange-400 hover:text-red-700 transition"
